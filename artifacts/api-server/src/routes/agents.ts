...
const DEFAULT_AGENTS = [
  {
    ...
    primaryModel: { provider: "openai", model: "o3", enabled: true, creativity: 0.7, timeoutSeconds: 240 },
    secondaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
    tertiaryModel: { provider: "openai", model: "gpt-4o", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
  ...
  },
  {
    ...
    primaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: true, creativity: 0.7, timeoutSeconds: 240 },
    secondaryModel: { provider: "openai", model: "o3", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
    tertiaryModel: { provider: "openai", model: "gpt-4o", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
  ...
  },
  {
    ...
    primaryModel: { provider: "local", model: "none", enabled: true, creativity: 0, timeoutSeconds: 0 },
    secondaryModel: null,
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "local", model: "orchestrator", enabled: true, creativity: 0, timeoutSeconds: 0 },
    secondaryModel: null,
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: true, creativity: 0.7, timeoutSeconds: 240 },
    secondaryModel: { provider: "openai", model: "gpt-4o", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "openai", model: "gpt-4o", enabled: true, creativity: 0.7, timeoutSeconds: 240 },
    secondaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: false, creativity: 0.7, timeoutSeconds: 240 },
    tertiaryModel: null,
...
router.post("/agents/configs", async (req, res) => {
  try {
    ...
    const [created] = await db.insert(agentConfigsTable).values({
      ...
      primaryModel: body.primaryModel || { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: true, creativity: 0.7, timeoutSeconds: 240 },
