    ...
    <div className={`min-h-screen bg-[#0e1117] text-[#e2e8f0] flex ${isRTL ? "flex-row-reverse" : ""}`} dir={isRTL ? "rtl" : "ltr"}>
      <div className="w-[260px] min-w-[260px] bg-[#161b22] border-r border-white/7 flex flex-col h-screen overflow-hidden">
        <div className="p-3 border-b border-white/7 flex items-center gap-2">
          <Link href="/dashboard" className="text-[#b0bac5] hover:text-white transition-colors">
        ...
        <div className="flex-1 overflow-y-auto p-2">
          <div className="text-[10px] uppercase tracking-wider text-[#b0bac5] px-2 py-1 mb-1">
          ...
          <div className="text-[10px] uppercase tracking-wider text-[#b0bac5] px-2 py-1 mt-3 mb-1">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        {currentAgent ? (
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/7 bg-[#161b22]/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#b0bac5]">{currentAgent.agentKey} • {isRTL ? "ترتيب" : "Order"}: {currentAgent.pipelineOrder}</p>
                </div>
              </div>
          ...
          <div className="flex-1 flex items-center justify-center text-[#b0bac5]">
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center" onClick={() => setShowNewAgent(false)}>
          <div className="bg-[#161b22] border border-white/10 rounded-xl w-[420px] p-5" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "المفتاح (بالإنجليزية)" : "Agent Key (English)"}</label>
              ...
              <div>
                <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الاسم بالإنجليزية" : "Name (English)"}</label>
              ...
              <div>
                <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الاسم بالعربية" : "Name (Arabic)"}</label>
              ...
              <div>
                <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الوصف" : "Description"}</label>
  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 w-full px-2 py-2 rounded-md text-[12px] text-start transition-colors ${
        selected ? "bg-[#7c3aed]/15 text-[#e2e8f0]" : "text-[#b0bac5] hover:bg-white/5"
      }`}
    >
    ...
    <div className="bg-[#0d1117] border border-white/10 rounded-lg p-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className={`text-[11px] px-2 py-0.5 rounded-full ${current.enabled ? "bg-green-500/15 text-green-400" : "bg-white/5 text-[#b0bac5]"}`}
        >
    ...
    <div className="max-w-2xl space-y-4">
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] transition-colors ${
              agent.governorEnabled ? "bg-yellow-500/15 text-yellow-400 border border-yellow-500/30" : "bg-white/5 text-[#b0bac5] border border-white/10"
            }`}
          >
        ...
        <div className="bg-[#0d1117] border border-white/7 rounded-lg p-3 mb-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] transition-colors ${
                agent.autoGovernor ? "bg-emerald-500/15 text-emerald-400 border border-emerald-500/30" : "bg-white/5 text-[#b0bac5] border border-white/10"
              }`}
            >
          ...
          {agent.autoGovernor && (
            <div className="mt-2 grid grid-cols-3 gap-1.5">
              <div className="bg-[#161b22] rounded px-2 py-1.5 text-center">
                ...
                <div className="text-[9px] text-[#b0bac5]">{isRTL ? "0-20 نقطة" : "0-20 pts"}</div>
              ...
              <div className="bg-[#161b22] rounded px-2 py-1.5 text-center">
                ...
                <div className="text-[9px] text-[#b0bac5]">{isRTL ? "21-55 نقطة" : "21-55 pts"}</div>
              ...
              <div className="bg-[#161b22] rounded px-2 py-1.5 text-center">
                ...
                <div className="text-[9px] text-[#b0bac5]">{isRTL ? "56-100 نقطة" : "56-100 pts"}</div>
        ...
        {agent.governorEnabled && (() => {
          ...
          <div className="bg-[#0d1117] border border-yellow-500/20 rounded-lg p-3 mt-2">
            ...
            <p className="text-[10px] text-[#b0bac5] mb-2">
              {isRTL
      ...
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-[12px] text-[#b0bac5]">{isRTL ? "الإعدادات لكل نموذج أعلاه" : "Settings configured per-model above"}</span>
        </div>
...
function PromptTab({ agent, onUpdate, isRTL }: { agent: AgentConfig; onUpdate: (u: Partial<AgentConfig>) => void; isRTL: boolean }) {
  return (
    <div className="max-w-3xl space-y-4">
      <div>
        <label className="text-[12px] text-[#b0bac5] mb-2 block">{isRTL ? "التوجيه الرئيسي (System Prompt)" : "System Prompt (Main Directive)"}</label>
        <textarea
          ...
          dir="ltr"
        />
        <p className="text-[10px] text-[#b0bac5] mt-1">{isRTL ? "هذا التوجيه يُرسل كرسالة نظام في كل طلب يتلقاه الوكيل" : "This prompt is sent as the system message in every request the agent receives"}</p>
      </div>
      <div>
        <label className="text-[12px] text-[#b0bac5] mb-2 block">{isRTL ? "الوصف" : "Description"}</label>
        <textarea
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4">
        ...
        <p className="text-[11px] text-[#b0bac5] mb-3">{isRTL ? "سياقات مؤقتة تُمسح بعد كل بناء" : "Temporary context, cleared after each build"}</p>
      ...
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4">
        ...
        <p className="text-[11px] text-[#b0bac5] mb-3">{isRTL ? "تعلّمات دائمة تُحفظ عبر الجلسات" : "Persistent learnings saved across sessions"}</p>
        <div className="space-y-2 mb-3">
  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-4">
        <p className="text-[12px] text-[#b0bac5]">{isRTL ? "كل صلاحية مرتبطة بأداة حقيقية — فعّلها أو عطّلها" : "Each permission controls a real tool"}</p>
        <div className="flex items-center gap-3 text-[11px]">
          <span className="text-[#b0bac5]">{currentPerms.filter(p => PERMS.some(d => d.key === p)).length}/{PERMS.length}</span>
        ...
        return (
          <div key={cat.key} className="mb-5">
            <div className="flex items-center gap-2 mb-2 px-1">
              ...
              <span className="text-[10px] text-[#b0bac5]">({enabledInCat}/{catPerms.length})</span>
              <button onClick={() => { const keys = catPerms.map(p => p.key); const allOn = keys.every(k => currentPerms.includes(k)); onUpdate({ permissions: allOn ? currentPerms.filter(p => !keys.includes(p)) : [...new Set([...currentPerms, ...keys])] }); }} className={`text-[10px] hover:text-[#7c3aed] transition-colors ${isRTL ? "mr-auto" : "ml-auto"}`} style={{ color: "#b0bac5" }}>
                ...
                return (
                  <div key={perm.key} className="rounded-lg border transition-all" style={{ borderColor: active ? (perm.risk === "critical" ? "rgba(239,68,68,0.3)" : "rgba(124,58,237,0.3)") : "rgba(255,255,255,0.07)" }}>
                    <div className={`flex items-center gap-2.5 px-3 py-2.5 cursor-pointer hover:bg-white/[0.02] transition-colors rounded-lg ${active ? (perm.risk === "critical" ? "bg-red-500/5" : "bg-[#7c3aed]/5") : "bg-[#0d1117]"}`}
                      ...
                      <perm.icon className={`w-4 h-4 flex-shrink-0 ${active ? r.text : "text-[#b0bac5]"}`} />
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className={`text-[12px] font-medium ${active ? "text-[#e2e8f0]" : "text-[#b0bac5]"}`}>{isRTL ? perm.nameAr : perm.nameEn}</span>
                          <span className="text-[9px] font-mono text-[#b0bac5]/50">{perm.key}</span>
                        </div>
                      </div>
                      <span className={`text-[9px] px-1.5 py-0.5 rounded ${r.bg} ${r.text} border ${r.border}`}>{isRTL ? r.labelAr : r.labelEn}</span>
                      <button onClick={(e) => { e.stopPropagation(); setExpandedInfo(expanded ? null : perm.key); }} className="p-1 hover:bg-white/5 rounded transition-colors"><Info className="w-3.5 h-3.5 text-[#b0bac5]" /></button>
                    </div>
...
function InstructionsTab({ agent, onUpdate, isRTL }: { agent: AgentConfig; onUpdate: (u: Partial<AgentConfig>) => void; isRTL: boolean }) {
  return (
    <div className="max-w-3xl">
      <label className="text-[12px] text-[#b0bac5] mb-2 block">{isRTL ? "تعليمات وملاحظات إضافية" : "Additional Instructions & Notes"}</label>
      <textarea
      ...
      />
      <p className="text-[10px] text-[#b0bac5] mt-1">{isRTL ? "هذه التعليمات تُضاف كسياق إضافي عند كل استدعاء" : "These instructions are appended as additional context on every invocation"}</p>
    </div>
  );
}
  ...
  return (
    <div className="max-w-2xl space-y-6">
        ...
        <div className="space-y-1">
          {pipelineAgents.map((a, i) => (
            <div key={a.agentKey} className={`flex items-center gap-2 px-3 py-2 rounded-lg text-[12px] ${a.agentKey === agent.agentKey ? "bg-[#7c3aed]/15 border border-[#7c3aed]/30" : "bg-[#0d1117] border border-white/7"}`}>
              <GripVertical className="w-3.5 h-3.5 text-[#b0bac5]" />
              ...
              {i < pipelineAgents.length - 1 && <ChevronRight className="w-3.5 h-3.5 text-[#b0bac5]" />}
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4 space-y-3">
        ...
        <div>
          <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "رقم الترتيب" : "Pipeline Order"}</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "يستلم من" : "Receives From"}</label>
          ...
          <div>
            <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "يسلّم إلى" : "Sends To"}</label>
        ...
        <div>
          <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الدور عند الاستلام" : "Role on Receive"}</label>
        ...
        <div>
          <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الدور عند التسليم" : "Role on Send"}</label>
  ...
  return (
    <div className="max-w-2xl space-y-4">
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4 space-y-4">
        ...
        <div>
          <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "الحد الأقصى للتوكن لكل استدعاء" : "Max Tokens Per Call"}</label>
          ...
          <div className="flex justify-between text-[10px] text-[#b0bac5] mt-1">
      ...
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4 space-y-4">
        ...
        <div>
          <label className="text-[11px] text-[#b0bac5] mb-1 block">{isRTL ? "حجم الدفعة (عدد الملفات)" : "Batch Size (files per batch)"}</label>
        ...
        <p className="text-[11px] text-[#b0bac5] leading-relaxed">
          {isRTL
      ...
      <div className="bg-[#161b22] border border-white/7 rounded-xl p-4">
        ...
        <p className="text-[11px] text-[#b0bac5] mt-1">{isRTL ? "إجمالي التكلفة منذ إنشاء الوكيل" : "Total cost since agent creation"}</p>
      </div>
    </div>
  );
}
...
function CodeTab({ agent, onUpdate, isRTL }: { agent: AgentConfig; onUpdate: (u: Partial<AgentConfig>) => void; isRTL: boolean }) {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-[11px] text-[#b0bac5] mb-3">
        {isRTL
      ...
      <div className="space-y-2">
        {(agent.sourceFiles || []).map((file, i) => (
          <div key={i} className="flex items-center gap-2 bg-[#0d1117] border border-white/7 rounded-lg px-3 py-2.5 group">
            <Code className="w-4 h-4 text-[#b0bac5] flex-shrink-0" />
        ...
        {(!agent.sourceFiles || agent.sourceFiles.length === 0) && (
          <p className="text-[12px] text-[#b0bac5]">{isRTL ? "لا توجد ملفات مصدرية — الوكيل يعمل على جميع الملفات" : "No source files — agent operates on all files"}</p>
        )}
      </div>
    </div>
  );
...
function LogsTab({ agent, isRTL }: { agent: AgentConfig; isRTL: boolean }) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16 text-[#b0bac5]">
  ...
  return (
    <div className="max-w-4xl space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-[#b0bac5]">
      ...
      {logs.length === 0 ? (
        <div className="text-center py-16 text-[#b0bac5]">
          ...
          {logs.map((log) => (
            ...
            >
              <div className="flex items-center gap-2.5 px-3 py-2">
                ...
                <div className="flex items-center gap-3 text-[11px] text-[#b0bac5] shrink-0">
                  {log.tokensUsed > 0 && (
                ...
                <div className="px-3 pb-3 border-t border-white/5 mt-0 pt-2 space-y-2">
                  ...
                  {log.details && Object.keys(log.details).length > 0 && (
                    <div className="bg-black/30 rounded-lg p-2">
                      <pre className="text-[11px] text-[#b0bac5] overflow-x-auto whitespace-pre-wrap font-mono leading-relaxed">
        ...
        {statCards.map((card, i) => (
          <div key={i} className="bg-[#161b22] border border-white/7 rounded-xl p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[11px] text-[#b0bac5]">{card.label}</span>
            </div>
          ...
          <div className="space-y-1">
            {stats.recentTasks.slice(0, 10).map((task: any, i: number) => (
              <div key={i} className="flex items-center gap-2 text-[12px] py-1.5 border-b border-white/5 last:border-0">
                ...
                <span className="flex-1 text-[#b0bac5]">{new Date(task.createdAt).toLocaleString()}</span>
                <span>{(task.tokensUsed || 0).toLocaleString()} tok</span>
                <span className="text-[#b0bac5]">{task.durationMs ? `${(task.durationMs / 1000).toFixed(1)}s` : "-"}</span>
              </div>
            ))}
          </div>
        </div>
    ...
    <div className="max-w-4xl">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={fetchApprovals} className="p-1.5 hover:bg-white/5 rounded transition-colors"><RefreshCw className="w-4 h-4 text-[#b0bac5]" /></button>
        </div>
      </div>

      <div className="flex gap-2 mb-4">
        {(["all", "pending", "approved", "rejected"] as const).map(f => (
          <button key={f} onClick={() => setFilter(f)} className={`px-3 py-1.5 rounded-lg text-[11px] transition-colors ${filter === f ? "bg-[#7c3aed]/15 text-[#7c3aed] border border-[#7c3aed]/30" : "bg-[#0d1117] text-[#b0bac5] border border-white/7"}`}>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-[#b0bac5] text-sm">{isRTL ? "لا توجد طلبات" : "No requests"}</div>
      ) : (
        <div className="space-y-2">
          {filtered.map((a: any) => (
            <div key={a.id} className={`rounded-xl border p-4 transition-colors ${a.status === "pending" ? "bg-yellow-500/5 border-yellow-500/20" : "bg-[#161b22] border-white/7"}`}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-[#b0bac5] ml-auto">{new Date(a.createdAt).toLocaleString("ar-SA")}</span>
              </div>
              <div className="text-[11px] text-[#b0bac5] mb-2 font-mono bg-[#0d1117] rounded-lg px-3 py-2 max-h-20 overflow-auto">
                {JSON.stringify(a.input, null, 1)?.slice(0, 300)}
              </div>
              {a.explanation && <p className="text-[11px] text-[#b0bac5] mb-2">{a.explanation}</p>}
              {a.status === "pending" && (
  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[10px] text-[#b0bac5]">{logs.length} {isRTL ? "سجل" : "entries"}</span>
      </div>
      {loading ? (
        <div className="flex justify-center py-12"><RefreshCw className="w-6 h-6 animate-spin text-[#7c3aed]" /></div>
      ) : logs.length === 0 ? (
        <div className="text-center py-12 text-[#b0bac5] text-sm">{isRTL ? "لا توجد سجلات" : "No audit logs"}</div>
      ) : (
        <div className="space-y-1">
          {logs.map((log: any) => (
            <div key={log.id} className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#161b22] border border-white/5 text-[11px]">
              <span className="text-[9px] text-[#b0bac5] w-[140px] flex-shrink-0">{new Date(log.createdAt).toLocaleString("ar-SA")}</span>
              ...
              <span className="font-mono text-[#b0bac5] w-[120px] flex-shrink-0">{log.tool || "-"}</span>
              <span className="text-[9px] text-[#b0bac5] flex-1 truncate">{log.input ? JSON.stringify(log.input).slice(0, 80) : ""}</span>
              {log.durationMs && <span className="text-[9px] text-[#b0bac5]">{log.durationMs}ms</span>}
            </div>
          ))}
        </div>
      )}
