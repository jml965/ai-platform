...
- **Live Preview:** React projects are previewed in-browser using Babel standalone + React/ReactDOM from CDN for transpilation. Static HTML/CSS/JS projects use direct srcDoc injection. The preview auto-refreshes when builds complete. Error display includes formatted error messages with line/column info.
